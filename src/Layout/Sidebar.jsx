...
const Sidebar = ({ collapsed, setCollapsed }) => {
  ...
  const allMenus = {
    superadmin: [
      ...
      { name: "Admin", icon: faUsers, path: "/superadmin/Owner" },
      { name: "Plans & Pricing", icon: faUsers, path: "/superadmin/Plans&Pricing" },
      {
        name: "Payments",
        icon: faUsers,
        key: "Payments",
    ...
    admin: [
      ...
      { name: "Classes Schedule", icon: faCalendarAlt, path: "/admin/classesSchedule" },
    ...
    receptionist: [
      ...
      { name: "Payment", icon: faFileAlt, path: "/receptionist/payment" },
    ],
