 ...
 */
const ReceptionistQrCheckin = ({ member_id, member_name }) => {
    ...
    <div className="card border-0 shadow-sm">
      <div className="card-body">
        <div className="d-flex align-items-center mb-4">
          ...
          <div>
            <h1 className="fw-bold mb-2">Gym Check-in QR Code</h1>
        ...
        {/* History Table */}
        <div className="mt-4">
          <h5 className="fw-bold mb-3">Today's Check-in History</h5>
